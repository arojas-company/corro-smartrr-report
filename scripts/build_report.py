...
def build_summary(raw_df, customers_df):
    if raw_df.empty:
        return pd.DataFrame([
...
def write_excel(summary_df, customers_df, purchase_states_df, product_volume_df, months_df, raw_df, ranges_df):
...
def write_json(summary_df, customers_df, purchase_states_df, product_volume_df, months_df, raw_df, ranges_df):
...
def main():
    ...
    summary_df = build_summary(raw_df, customers_df)
